      ...
      <div style={{ width: '100%', maxWidth: '400px' }}>
        ...
        {sent ? (
          <div style={{ padding: '20px', background: '#111318', border: '1px solid rgba(74,222,128,.2)', borderRadius: '8px', color: '#4ade80', fontSize: '14px', lineHeight: '1.6' }}>
            Check your email. We sent a sign-in link to <strong>{email}</strong>. Click it to access your account.
          </div>
        ) : (
          <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
              <label style={{ fontFamily: 'monospace', fontSize: '11px', letterSpacing: '.1em', textTransform: 'uppercase', color: '#4a5568' }}>
                Email address
              </label>
              <input
                type="email"
        ...
        <p style={{ marginTop: '20px', fontSize: '12px', color: '#4a5568', textAlign: 'center' }}>
